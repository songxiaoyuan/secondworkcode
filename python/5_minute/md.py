...
class BandAndTrigger(object):
	...
	def is_trend_close_time(self):
		...
		is_band_close = self.is_band_close_time(self._direction,self._lastprice,
											self._now_middle_value_5,self._param_loss_edge,self._param_profit_edge)
		...
		is_middle_cross_close = self.is_middle_cross_close_time(self._direction,self._lastprice,self._now_middle_value_1)
...
def main(filename,total_obj):
	...
	# 这个是螺纹钢的 tick 1
	param_dict = {"band_loss_edge":3,"band_profit_edge":30,"band_open_edge1":3,
