...
class BandAndTrigger(object):
	...
	def __init__(self,param_dic):
		...
		if len(self._lastprice_array) ==0:
			...
			bf.get_config_info(tmp_pre_ema_array_60,tmp_pre_ema_array_5,self._lastprice_array,config_file)
	...
	def get_md_data(self,md_array,lastone):
		...
		self._now_middle_60 = bf.get_ma_data(lastprice,self._lastprice_array,self._ema_period)
